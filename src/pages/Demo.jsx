...
function Demo() {
  ...
  const pageConfigs = {
    ...
    "GO優惠": {
      ...
      description: "**優化資訊架構**，集中所有優惠、商品資訊於一個頁面，進一步**提升功能的使用率與體驗**",
      features: [
        "**「主打優惠券」**：提供熱門的優惠券，讓使用者快速找到最適合自己的優惠",
        "**「線上商城」**：此區收錄了北捷的各種文創、紀念小物",
        "**「旅遊趣」**：將交通、住宿的優惠卷集中於此區，並保留主題地圖功能",
        "**「旅遊票推薦」**：販售旅遊套票，讓使用者快速找到最適合自己的旅遊套票"
      ],
