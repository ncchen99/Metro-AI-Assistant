    ...
    const LoadingMessage = () => (
        <div className="flex items-start gap-3">
            <div className="w-6 h-6 flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 transition-colors duration-300" fill={mode === 'work' ? '#4088F4' : '#38c693'} viewBox="0 0 20 20">
                                    ...
                                    <div className="text-[12px] font-medium tracking-[1.2px] leading-[1.2] text-[#007AB0]">
                                        <ReactMarkdown
                                            ...
                                            components={{
                                                ...
                                                code: ({ children }) => <span className="bg-white/30 px-1 rounded text-xs font-mono">{children}</span>,
                                    ...
                                    <div className={`text-[12px] font-medium tracking-[1.2px] leading-[1.2] ${message.type === 'ai' ? 'text-[#007AB0]' : 'text-text-gray'
                                        ...
                                        <ReactMarkdown
                                            ...
                                            components={{
                                                ...
                                                em: ({ children }) => <span className="italic">{children}</span>,
                                                code: ({ children }) => <span className="bg-white/30 px-1 rounded text-xs font-mono">{children}</span>,
                                                pre: ({ children }) => <pre className="bg-white/30 p-2 rounded text-xs font-mono overflow-x-auto my-1">{children}</pre>,
                                                ...
                                                h3: ({ children }) => <div className="font-medium mb-1">{children}</div>
                                            }}
                                        >
                                            {message.content}
                                        </ReactMarkdown>
