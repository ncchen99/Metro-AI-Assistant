const AIChat = ({ mode = 'work' }) => {
  // 示例訊息數據 - 未來會從API獲取
  const messages = [
    {
      id: 1,
      type: 'ai',
      content: '我是AI助理xxx，有什麼我能幫您的嗎？',
      timestamp: new Date()
    },
    {
      id: 2,
    ...
    },
    {
      id: 3,
      type: 'ai',
      content: '我不知道，這裡應該就是念誠麒安訓練的內容，所以我只是隨便亂打',
      timestamp: new Date()
    }
  ]
  ...
  return (
    <div className="relative z-10 px-8 pb-12">
      ...
      <div className="w-[330px] h-[420px] rounded-[20px] bg-white/20 backdrop-blur-md shadow-[0_4px_8px_0_rgba(0,0,0,0.1),inset_2px_2px_4px_0_rgba(255,255,255,0.5),inset_-2px_-2px_4px_0_rgba(0,0,0,0.05)] relative mx-auto overflow-hidden">
        ...
        <div className="h-full overflow-y-auto px-4 py-6 space-y-4 scrollbar-hide">
