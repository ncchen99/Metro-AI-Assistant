...
function CallingPopup({ mode = 'work' }) {
  const AIAvatar = () => (
    <div className="w-8 h-8 flex items-center justify-center flex-shrink-0">
      <svg className="w-6 h-6 transition-colors duration-300" fill={mode === 'work' ? '#4088F4' : '#38c693'} viewBox="0 0 20 20">
    ...
    >
      ...
      >
        ...
        <div
          ...
          data-name="Text"
        >
          <div className="text-m text-neutral-500" data-name="Description">
            捷徑：專注模式
          </div>
          <div
        ...
        <img
          src="https://api.builder.io/api/v1/image/assets/TEMP/bbf15aa33027f1fab5da973b19d88042212bef7c?placeholderIfAbsent=true"
