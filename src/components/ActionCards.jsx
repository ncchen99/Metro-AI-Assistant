...
const ActionCards = ({ mode = 'work' }) => {
  ...
  return (
    <div className="relative z-10 px-[20px] pt-8 pb-4">
        ...
        <div className="relative">
          <div className="w-[107px] h-[70px] rounded-[10px] bg-white/30 backdrop-blur-sm border border-transparent shadow-[0_2px_4px_0_rgba(0,0,0,0.1),inset_1px_1px_2px_0_rgba(255,255,255,0.4),inset_-1px_-1px_2px_0_rgba(0,0,0,0.05)] relative">
            <div className="p-[5px] relative h-full">
              ...
              <svg className={`w-3 h-3 absolute top-2 right-2 transition-colors duration-300 ${mode === 'work' ? 'text-primary-blue' : 'text-travel-green'}`} fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="relative">
          <div className="w-[107px] h-[70px] rounded-[10px] bg-white/30 backdrop-blur-sm border border-transparent shadow-[0_2px_4px_0_rgba(0,0,0,0.1),inset_1px_1px_2px_0_rgba(255,255,255,0.4),inset_-1px_-1px_2px_0_rgba(0,0,0,0.05)] relative">
            <div className="p-[5px] relative h-full">
              ...
              {/* Label */}
              <div className="absolute bottom-1 left-2">
                <span className={`text-xs font-bold tracking-[0.1em] transition-colors duration-300 ${mode === 'work' ? 'text-primary-blue' : 'text-travel-green'}`}>Podcast</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="w-[107px] h-[70px] rounded-[10px] bg-white/30 backdrop-blur-sm border border-transparent shadow-[0_2px_4px_0_rgba(0,0,0,0.1),inset_1px_1px_2px_0_rgba(255,255,255,0.4),inset_-1px_-1px_2px_0_rgba(0,0,0,0.05)] relative">
            <div className="p-[5px] relative h-full">
              ...
              {/* Label */}
              <div className="absolute bottom-1 left-2">
                <span className={`text-xs font-bold tracking-[0.1em] transition-colors duration-300 ${mode === 'work' ? 'text-primary-blue' : 'text-travel-green'}`}>印刷廠商的電話</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {showCallingPopup && (
        <div
          className={`fixed top-20 left-1/2 transform -translate-x-1/2 z-[9999] transition-all duration-200 ease-out ${
            isAnimatingOut
