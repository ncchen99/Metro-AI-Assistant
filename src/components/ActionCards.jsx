      ...
      <div className="grid grid-cols-3 gap-x-5 gap-y-5">
          ...
          <div className="w-[107px] h-[70px] rounded-[10px] bg-white/30 backdrop-blur-sm border border-transparent shadow-[0_2px_4px_0_rgba(0,0,0,0.1),inset_1px_1px_2px_0_rgba(255,255,255,0.4),inset_-1px_-1px_2px_0_rgba(0,0,0,0.05)] relative">
            <div className="p-[5px] relative h-full">
              ...
              <div className="absolute top-2 left-2">
                <svg className={`w-6 h-6 transition-colors duration-300 ${mode === 'work' ? 'text-primary-blue' : 'text-travel-green'}`} fill="currentColor" viewBox="0 0 24 24" >
              ...
              <div className="absolute bottom-1 left-2">
                <span className={`text-sm font-bold tracking-[0.1em] transition-colors duration-300 ${mode === 'work' ? 'text-primary-blue' : 'text-travel-green'}`}>我的票卡</span>
              </div>
            </div>
          </div>
        ...
        <div className="relative">
          <div className="w-[107px] h-[70px] rounded-[10px] bg-white/30 backdrop-blur-sm border border-transparent shadow-[0_2px_4px_0_rgba(0,0,0,0.1),inset_1px_1px_2px_0_rgba(255,255,255,0.4),inset_-1px_-1px_2px_0_rgba(0,0,0,0.05)] relative">
            <div className="p-[5px] relative h-full">
              ...
              <svg className={`absolute top-2 left-2 w-6 h-6 transition-colors duration-300 ${mode === 'work' ? 'text-primary-blue' : 'text-travel-green'}`} fill="currentColor" viewBox="0 0 24 24" >
              ...
              {/* Label */}
              <div className="absolute bottom-1 left-2">
                <span className={`text-sm font-bold tracking-[0.1em] transition-colors duration-300 ${mode === 'work' ? 'text-primary-blue' : 'text-travel-green'}`}>
        ...
        <div className="relative">
          ...
          >
            <div className="p-[5px] relative h-full">
              ...
              {/* Label */}
              <div className="absolute bottom-1 left-2">
                <span className={`text-sm font-bold tracking-[0.1em] transition-colors duration-300 ${mode === 'work' ? 'text-primary-blue' : 'text-travel-green'}`}> {mode === 'work' ? '印刷廠商的電話' : '緊急聯絡人'}</span>
              </div>
            </div>
          </div>
        ...
        <div className="relative">
          <div className={`w-[107px] h-[70px] rounded-[10px] bg-white/30 backdrop-blur-sm border border-dashed border-opacity-30 shadow-[0_2px_4px_0_rgba(0,0,0,0.1),inset_1px_1px_2px_0_rgba(255,255,255,0.4),inset_-1px_-1px_2px_0_rgba(0,0,0,0.05)] relative flex items-center justify-center transition-colors duration-300 ${mode === 'work' ? 'border-[#1577FF]' : 'border-[#38c693]'
            ...
            <svg className={`w-7 h-7 transition-colors duration-300 ${mode === 'work' ? 'text-light-blue' : 'text-light-green'}`} fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24">
