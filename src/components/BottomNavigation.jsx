      ...
      <div className="w-full h-[77px] bg-white flex justify-center items-center pb-2">
        ...
        <div className="flex w-[375px] h-[41px] justify-center items-center px-2 relative top-3">
          ...
          <div className="flex flex-col justify-center items-center flex-1 gap-1 py-3 relative">
            ...
            <div className="relative">
              <div className="w-[25px] h-[25px] bg-white rounded-full flex items-center justify-center">
                <svg className="w-6 h-6" fill="#4088F4" viewBox="0 0 21 21">
            ...
            <span className="text-sm font-medium text-primary-blue tracking-[-0.24px]">AI 助理</span>
          </div>

          {/* Home Tab */}
          <div className="flex flex-col justify-center items-center flex-1 gap-1 py-3">
            <svg className="w-7 h-7" fill="#6F6F6F" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M9.293 2.293a1 1 0 011.414 0l7 7A1 1 0 0117 11h-1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-3a1 1 0 00-1-1H9a1 1 0 00-1 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-6H3a1 1 0 01-.707-1.707l7-7z" clipRule="evenodd" />
            </svg>
            <span className="text-sm font-medium text-gray-500 tracking-[-0.24px]">首頁</span>
          </div>
          ...
          <div className="flex flex-col justify-center items-center flex-1 gap-1 py-3">
            ...
            <span className="text-sm font-medium text-gray-500 tracking-[-0.24px]">我的帳戶</span>
          </div>
        </div>
